...
- This module supports custom kms policy. Use `custom_kms_policy` variable for either organization or non-organization trail kms
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cloudtrail"></a> [cloudtrail](#module\_cloudtrail) | boldlink/s3/aws | 2.3.0 |
| <a name="module_cloudtrail_cloudwatch"></a> [cloudtrail\_cloudwatch](#module\_cloudtrail\_cloudwatch) | boldlink/iam-role/aws | 1.1.0 |
| <a name="module_trail_kms"></a> [trail\_kms](#module\_trail\_kms) | boldlink/kms/aws | 1.1.0 |
...
| [aws_iam_policy_document.org_kms_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
