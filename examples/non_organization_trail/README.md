...
# An example showing the creation with non-organization configuration
...
| <a name="input_name"></a> [name](#input\_name) | Name of the stack | `string` | `"non-organization-trail-example"` | no |
